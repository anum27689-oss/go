    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-surface-container-lowest p-4">
            <Card className="w-full max-w-sm relative">
                <Link href="/home" className="absolute top-4 left-4 text-on-surface-variant hover:text-primary transition-colors p-2 rounded-full">
                ...
                <CardContent className="flex flex-col gap-4">
                    <Button onClick={handleGoogleSignIn} className="w-full h-12" variant="outline">
